...
secret_name = "projects/112728208189/secrets/env_key/versions/1"

def get_secret_value(secret_name):
    """
    Retrieves the secret value from Secret Manager.
    """
    client = secretmanager.SecretManagerServiceClient()  # No credential configuration needed
    resource_name = client.secret_version_path(secret_name)
